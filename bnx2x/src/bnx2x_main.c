...
#else
void bnx2x_esx_init_tx_ring(struct bnx2x *bp, int esx_netq_index)
#endif
{
	int i;
	u8 cos;
...
static void bnx2x_shutdown(struct pci_dev *pdev)
{
	...
	/* Don't remove the netedvice, as there are scenarios which will cause
